...
data HuskyType a = HuskyData                            -- a is a "phantom"
...
data QuantumBool = QuantumTrue
                 | QuantumFalse
                 | QuantumBoth deriving (Eq, Enum, Show)
...
type AuthorName = String
data TAuthor = Fiction AuthorName | Nonfiction AuthorName deriving (Eq, Show)
...
type Gardener = String
data TGarden = Gardenia Gardener | Daisy Gardener | Rose  Gardener | Lilac Gardener deriving Show
