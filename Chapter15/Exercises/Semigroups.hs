module Chapter15.Exercises.Semigroups where
...
type ThreeAssoc = Three (Sum Int) String String ->
                  Three (Sum Int) String String ->
                  Three (Sum Int) String String -> Bool
...
type FourAssoc = Four (Sum Int) (Product Int) String String ->
                 Four (Sum Int) (Product Int) String String ->
                 Four (Sum Int) (Product Int) String String -> Bool
