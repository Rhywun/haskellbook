...
-- This allows us to throw one or more various exception types without having to
-- unify them under a sum type
...
{-
runDisc 0 -- Arith divide by zero
runDisc 1 -- Async stack overflow
runDisc 2 -- SomethingElse
-}
